...
describe ActiveFacet::Filter do

  let(:basic_class) { Class.new }
  let(:acts_as_class) { Class.new { include ActiveFacet::ActsAsActiveFacet; acts_as_active_facet } }
  let(:inherited_acts_as_class) { Class.new(basic_class) { include ActiveFacet::ActsAsActiveFacet; acts_as_active_facet } }
  ...
  describe "register" do
    ...
    it { expect{subject}.to raise_error(ActiveFacet::Errors::ConfigurationError,ActiveFacet::Errors::ConfigurationError::ACTS_AS_ERROR_MSG) }
  ...
  describe "filterable?" do
    ...
    context "basic" do
      let(:inheritable_class) { Class.new { include ActiveFacet::ActsAsActiveFacet; acts_as_active_facet } }
