...
describe ActiveFacets::Config do
  ...
  describe ".field_set_itterator" do
    ...
    context "uncompiled" do
      let(:field_set) { :a }
      let(:prehook) { }
      it { expect{subject}.to raise_error(ActiveFacets::Errors::ConfigurationError, ActiveFacets::Errors::ConfigurationError::COMPILED_ERROR_MSG)}
    end
