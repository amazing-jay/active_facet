...
describe ActiveFacets::ActsAsActiveFacet do
  ...
  describe "acts_as_active_facet" do
    ...
    let(:receiver) { Class.new { include ActiveFacets::ActsAsActiveFacet } }
    let(:options) { {} }
  ...
  describe "dynamic methods" do
    ...
    describe "facet_filter" do
      ...
      before do
        ...
        allow(ActiveFacets::Filter).to receive(:register).and_call_original
        subject
      end
      ...
      it { expect(ActiveFacets::Filter).to have_received(:register).with(receiver, filter_name, filter_method_name) }
      ...
      context "proc" do
        ...
        it { expect(ActiveFacets::Filter).to have_received(:register).with(receiver, filter_name, "registered_filter_foo") }
      end
