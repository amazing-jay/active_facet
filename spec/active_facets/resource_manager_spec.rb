...
describe ActiveFacets::ResourceManager do
  ...
  #       # raise ActiveFacets::Errors::LookupError.new "Unable to locate serializer for:: " + [resource_class.name, serializer, type, version].to_s
